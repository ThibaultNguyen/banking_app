...
import static com.soprabanking.dxp.tppconnectortinkais.client.UriConstants.TINK_STATISTICS;
...
public interface StatisticClient {
    ...
    @POST(TINK_STATISTICS)
    @Headers(CONTENT_TYPE_APPLICATION_JSON)
    Mono<List<StatisticClientDto>> queryStatistics(@Header(AUTHORIZATION) String customerBearer,
                                                   @Body StatisticClientDto statisticClientDto);
}
